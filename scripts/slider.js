...
sliders.forEach((slider, i) => {
  ...
  sliderControlPrev[i].addEventListener('click', () => {
    ...
    setTimeout(function(){ isSlide = false; }, 500);
  });
  ...
  function autoSlide() {
    ...
    if(slider.scrollLeft > prevScrollLeft) {
        return slider.scrollLeft += positionDiff > slideWidth / 4 ? valDifference : -positionDiff;
    }
    slider.scrollLeft -= positionDiff > slideWidth / 4 ? valDifference : -positionDiff;
  }
